...
def register_stock_for_date(
    ...
    page.wait_for_timeout(1000)
    page.locator("data-testid=drop_prdname_search").fill(product_name)
    page.wait_for_timeout(1000)
    ...
    # 입고 수량 입력 및 저장
    instock = 100
    page.locator("data-testid=input_qty").fill(str(instock))
    page.wait_for_timeout(500)

    expected = int(stock) + instock
    page.locator("data-testid=input_memo").fill(past_memo)
    page.wait_for_timeout(500)
...
class StockManager:
    ...
    def get_current_stock(self):
        ...
        self.page.locator("data-testid=input_search").fill(self.product_name)
    ...
    def perform_inflow(self, quantity: int):
        ...
        self.page.locator("data-testid=btn_stockadd").click()
        ...
        self.page.locator("data-testid=input_qty").fill(str(quantity))
        self.page.wait_for_timeout(500)
        self.page.locator("data-testid=input_memo").fill("30자까지 제한인데요. 최대글자수 꽉꽉채워서 등록합니다.")
        self.page.wait_for_timeout(500)
